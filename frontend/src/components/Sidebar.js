...
import {
  ...
  FiTruck, FiMap, FiBox, FiSettings
} from 'react-icons/fi';
import { toast } from 'react-hot-toast';
...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  const menuConfig = {
    superadmin: [
      { label: 'Workboard', path: '/workboard', icon: FiPieChart },
      { label: 'Dashboard', path: '/dashboard', icon: FiActivity },
      { label: 'Production', path: '/production-tracking', icon: FiSettings },
      { label: 'QA / Defects', path: '/quality-assurance', icon: FiCheckSquare },
      { label: 'Supply Chain', path: '/supply-chain', icon: FiTruck },
      { label: 'Field Service', path: '/field-service', icon: FiMap },
      { label: 'All Projects', path: '/projects', icon: FiBriefcase },
      { label: 'Manage Users', path: '/users-management', icon: FiUsers },
      { label: 'System Logs', path: '/audit-logs', icon: FiActivity },
    ],
    admin: [
      { label: 'Workboard', path: '/workboard', icon: FiPieChart },
      { label: 'Dashboard', path: '/dashboard', icon: FiActivity },
    ...
    tester: [
      { label: 'Workboard', path: '/workboard', icon: FiPieChart },
      { label: 'My Dashboard', path: '/dashboard', icon: FiActivity },
      { label: 'Quality Assurance', path: '/quality-assurance', icon: FiCheckSquare },
      { label: 'QA Queue', path: '/issues', icon: FiCheckSquare },
      { label: 'My Projects', path: '/my-projects', icon: FiBriefcase },
      { label: 'Field Tickets', path: '/field-service', icon: FiMap },
    ],
    developer: [
      { label: 'Workboard', path: '/workboard', icon: FiPieChart },
      { label: 'Production Status', path: '/production-tracking', icon: FiSettings },
      { label: 'My Tasks', path: '/issues', icon: FiList },
      { label: 'My Projects', path: '/my-projects', icon: FiBriefcase },
