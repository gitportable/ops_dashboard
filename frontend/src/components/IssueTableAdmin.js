...
const IssueTableAdmin = ({ issues = [], onRefresh }) => {
                  ...
                  {expandedId === id && (
                    <tr style={{ background: "#f0f7ff" }}>
                      <td colSpan={8} style={{ padding: "12px 20px", fontSize: "0.83rem", color: "#374151" }}>
                        ...
                        <IssueAttachmentsSection issue={issue} expandedRow={expandedId} />
                      </td>
                    </tr>
                  )}
                </React.Fragment>
...
export default IssueTableAdmin;
